...
public class AchController {
    ...
    public ResponseEntity<Object> createAchTransfer(@PathVariable("account_id") String accountId,
        ...
        String details = String.format("Transferencia ACH para la cuenta %s. Tipo: %s, ID Relación: %s, Monto: %s, Dirección: %s",
                accountId,
                request.getTransfer_type(),
                request.getRelationship_id(),
                request.getAmount(),
